...
Base: `docs/architecture/disaster-recovery-claude-round1.md`, `docs/architecture/disaster-recovery-codex-round1.md`, `docs/architecture/architecture-fase3-consolidada.md`, `docs/architecture/slo.md`, `docs/architecture/data-model.md`. Seção 43 do prompt mestre.
