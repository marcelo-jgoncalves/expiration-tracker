...
| `roadmap-evolution/17-multi-user-b2b-revised-strategy.md` | informativo (análise externa, não passou pelo protocolo AGENTS.md §4, sem ADR) | Revisão estrutural de Multi-User B2B (2026-08-29) — proposta para um novo ciclo Type 1; documento explicitamente se rotula "não implementar diretamente sem o protocolo arquitetural vigente". Movido da raiz em 2026-08-29 (limpeza de contexto), mesmo tratamento do doc 16 acima — arquivado como insumo informativo, nenhuma decisão tomada, nenhum código alterado |
