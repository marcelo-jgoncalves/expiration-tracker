...
| B2B-3 | Organization + Membership | **NOT STARTED (unblocked)** | `Organization`/`Membership`/GSI4 `MembershipByUser`/`ownerCount` (§4-6/8 do physical model) — `GlobalUser.userId` de B2B-2 já existe para `Membership.userId` referenciar |
