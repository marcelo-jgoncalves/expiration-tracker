...
| [ADR-0012](ADR-0012-whatsapp-cloud-api-channel.md) | Canal WhatsApp — Meta Cloud API direta, webhook inbox account-scoped, quota por destinatário único | `docs/architecture/reviews/whatsapp-channel-scoping/` |
| [ADR-0015](ADR-0015-visual-identity-v2-violet.md) | Identidade visual v2 (violeta, Plus Jakarta Sans, ícones Lucide) — decisão direta do usuário, substitui v1 | `docs/frontend/design-system-v2/`, D-307 |
| [ADR-0016](ADR-0016-legacy-tracking-retirement.md) | Retirada completa do "Rastreamento legado" (A10/G01, modelo M9) + migração/extensão da governança de entrega de solicitação (A22) para `document-archive` | `docs/architecture/reviews/legacy-tracking-retirement/`, D-334 |
