...
- **Gatilho para retomar**: requisito real de DSR (idealmente antes de fechar o primeiro cliente B2B que dependa disso) — quando retomado, o fence de `TenantStatus` em todo write path já deve entrar no escopo do primeiro desenho, não ser descoberto de novo rodada a rodada.
