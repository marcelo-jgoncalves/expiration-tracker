...
| W2-05 | DLQ/replay drill nas filas críticas — provar que replay não duplica side effects | P1 | `DONE` (claim estreita: só o caso `occurrenceId` inexistente, ver detalhe) |
| W2-06 | Restore drill real conforme `disaster-recovery.md` — medir RPO/RTO observados | P1 | `DONE` (só RTO medido, RPO aberto — ver detalhe) |
