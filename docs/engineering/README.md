...
Last verified:            2026-09-08 (E-018 — full-audit round2, eixo Governança Jurídica/Contratual/Terceiros, reaberto por D-231 (primeiro secret de vendor externo real, Meta Cloud API); gate ≥9.0 ainda não atingido (Claude 4,73→5,247, Codex 5,163→5,275, convergido em 2 rodadas), fixes reais em third-party-inventory.md (fornecedor Meta nomeado, 2 overclaims + 2 imprecisões corrigidos) — ver docs/architecture/README.md para o estado vigente completo, não duplicado aqui)
```
