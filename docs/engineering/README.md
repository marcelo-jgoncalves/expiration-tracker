...
Last verified:            2026-09-07 (E-015 — full-audit round2, eixo Privacidade e Governança de Dados, reaberto pós-purga real D-179/D-190; gate ≥9.0 ainda não atingido, nota cega Codex bloqueada por falha de infraestrutura do CLI — ver docs/architecture/README.md para o estado vigente completo, não duplicado aqui)
```
...
4. **Reabertura de um eixo já fechado** (`full-audit-round2-<eixo>-*`, mesmo padrão de nomenclatura acima, "round2" substitui "round1" no prefixo, não sufixo `-round2.md` isolado como o de uma nota Claude dentro da mesma rodada) — usada quando a recomendação de fechamento de um `full-audit-round1-<eixo>-summary.md` cita uma condição objetiva de reabertura (ex.: "reabrir quando X for implementado") e essa condição se materializa. Primeiro caso real: `full-audit-round2-privacidade-*` (E-015, 2026-09-07), reaberto porque a condição nomeada no fechamento round1 (purge worker real) foi satisfeita por D-179/D-190.
