...
/** A10 (Block 7, D-2xx) - full request history for one assignment, feeds the timeline. PERF-10:
 * REFERENCE - request history changes occasionally, not moment to moment. */
