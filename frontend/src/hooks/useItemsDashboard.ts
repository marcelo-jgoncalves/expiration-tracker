 ...
 * the user is expected to page through. PERF-10: OPERATIONAL - day-to-day renewal activity. */
 ...
 * "how many pages exist" from anything but the server's own `nextCursor`. PERF-10: OPERATIONAL,
 * same reasoning as the bounded view above. */
