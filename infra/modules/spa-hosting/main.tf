...
resource "aws_cloudfront_distribution" "spa" {
  ...
  # ADR-0016 Decision A (2026-09-25) retired the legacy guest surface (M10, D-037,
  # /guest/document-requests/*) in its entirety, including the two CloudFront behaviors
  # ("/guest/document-requests/*/info", ".../uploads") that used to route it same-origin to
  # guest-documents-handler.ts - /document-archive/guest/document-requests/* (the three
  # behaviors above) is the project's only surviving guest-upload surface.
