...
run "exactly_five_function_error_alarms_plus_one_backlog_alarm" {
  ...
  # Exactly 5 critical-function error alarms - not more, not fewer. ADR-0016 Decision A
  # (2026-09-25) retired the DocumentChasingDispatch alarm this suite used to also assert
  # (document-chasing feature, fully removed).
  assert {
