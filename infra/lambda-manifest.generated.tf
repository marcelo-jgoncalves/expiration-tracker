...
output "lambda_function_names" {
  value = [
    ...
    module.reminder_dispatch_outbox_relay.function_name,
...
output "lambda_published_versions" {
  value = {
    ...
    (module.reminder_dispatch_outbox_relay.function_name)               = module.reminder_dispatch_outbox_relay.published_version
    (module.reminder_dispatch_outbox_sweeper.function_name)             = module.reminder_dispatch_outbox_sweeper.published_version
