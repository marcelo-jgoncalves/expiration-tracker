...
const HANDLERS = [
  ...
  "reminder-claim-consumer-handler",
  "reminder-scan-enumerator-handler",
  "reminder-scan-page-handler",
  "reminder-scan-control-relay-handler",
  "reminder-scan-control-reconciler-handler",
  ...
  "reminder-dispatch-outbox-relay-handler",
  "reminder-dispatch-outbox-sweeper-handler",
  ...
  // D-152 (DELIVERY_RECORD LGPD purge, Prioridade 2 of quarantine-retention-scoping's
  // estado-final-consolidado.md): daily EventBridge Scheduler physical-purge job.
  "delivery-record-purge-handler",
